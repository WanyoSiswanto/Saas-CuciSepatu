...
export function ReceiptModal({ order, isOpen, onClose }: ReceiptModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/50 backdrop-blur-xs overflow-y-auto">
      <div className="relative w-full max-w-lg bg-white border border-slate-200 rounded-3xl shadow-2xl p-6 my-8">
        {/* Header Actions */}
        <div className="flex items-center justify-between pb-4 mb-4 border-b border-slate-100">
          <div>
            ...
            <p className="text-xs text-slate-500 mt-0.5">Format struk 58mm/80mm & integrasi pesan WhatsApp</p>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="grid grid-cols-3 gap-2 mb-5">
          <button
            onClick={handlePrint}
            className="flex items-center justify-center gap-2 px-3 py-2.5 rounded-xl bg-slate-900 text-white font-bold text-xs hover:bg-slate-800 transition shadow-xs"
          >
          ...
          <button
            ...
            className="flex items-center justify-center gap-2 px-3 py-2.5 rounded-xl bg-emerald-600 text-white font-bold text-xs hover:bg-emerald-700 transition shadow-xs"
          >
          ...
          <button
            ...
            className="flex items-center justify-center gap-2 px-3 py-2.5 rounded-xl bg-slate-100 text-slate-700 font-semibold text-xs hover:bg-slate-200 transition border border-slate-200"
          >
        ...
        <div className="flex justify-center p-3 bg-slate-100/70 rounded-2xl border border-slate-200/80">
          <div
            id="thermal-receipt"
            className="w-[300px] bg-white text-black p-5 rounded-xl font-mono text-[11px] leading-relaxed shadow-md border border-slate-200 select-text"
          >
            {/* Receipt Header */}
            ...
            <div className="space-y-1 font-semibold">
              ...
              <div className="flex justify-between text-xs">
                ...
                <span className={sisaBayar > 0 ? 'font-bold text-red-600' : 'text-emerald-700'}>
        ...
        <div className="mt-4 pt-3 border-t border-slate-100 flex items-center justify-between text-xs">
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="flex items-center gap-1.5 text-blue-600 hover:text-blue-700 font-bold transition"
          >
